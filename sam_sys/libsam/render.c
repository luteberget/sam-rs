...
if (debug)
{
    PrintOutput(1, sampledConsonantFlag, frequency1, frequency2, frequency3, amplitude1, amplitude2, amplitude3, pitches);
}
// -------------------
//pos47694:
...
if (debug)
{
    PrintOutput(2, sampledConsonantFlag, frequency1, frequency2, frequency3, amplitude1, amplitude2, amplitude3, pitches);
}
...
//pos38942:
    ...
    while(pos != 30)
    {
        ...
        printf("Set mouth idx=%d table[idx]=%d mouth=%d other=%d value=%d\n",pos, mouthFormants5_29[pos], 
        mouth, initialFrequency, newFrequency);
